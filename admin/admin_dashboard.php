<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2">
            <a href="ajout_admin.php" class="btn btn-sm btn-outline-primary me-2">Ajouter un Admin</a>
            <a href="ajout_apprenant.php" class="btn btn-sm btn-outline-primary me-2">Ajouter un Formateur</a>
