<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 text-primary">Ajout Admin</h1>
...
<h6 class="text-primary mt-5">Liste des Admin</h6>
    ...
    <table class="table table-striped table-sm">
        ...
        <tbody>
            <tr>
                ...
                $i = 1;
                while ($info = $select_admins->fetch()) {
                    echo "<td>$i</td>";
                    echo "<td>$info[nom]</td>";
                    ...
                    echo "<td>
                                    ...
                                    <a class=\"btn btn-warning\" href=\"modifier_ad.php?modif_a=$info[id]\">Modifier</a>";
                    echo "</tr>";
                    $i++;
                }
                ?>
